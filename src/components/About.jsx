...
const About = () => {
  ...
  const achievements = [
    { year: '2026', title: 'Estágio na Movement (Brudden)', description: 'Inovação: Discovery, prototipação e desenvolvimento Full-Stack de novos produtos.', type: 'Estágio' },
    { year: '2026', title: 'climAgro / CentralAgro', description: 'IA especializada para análise meteorológica agrícola.', type: 'Projeto' },
